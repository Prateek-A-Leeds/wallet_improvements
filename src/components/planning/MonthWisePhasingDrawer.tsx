...
export type MonthWisePhasingRecord = {
  id: number;
...
type MonthWisePhasingDrawerProps = {
  open: boolean;
  record: MonthWisePhasingRecord | null;
  onClose: () => void;
};

const pageSizeOptions = [10, 25, 50, 100] as const;

function MonthWisePhasingDrawer({
  open,
  record,
  onClose,
}: MonthWisePhasingDrawerProps) {
...
export default MonthWisePhasingDrawer;
